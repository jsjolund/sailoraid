...
\newglossaryentry{cidg}{name={CID},
	description={A Current Interrupt Device (CID) is a type of protection circuit for lithium-ion batteries.}}
...
\newglossaryentry{insg}{name={INS},
    description={Inertial Navigation System (INS) are navigation aids that use a accelerometers, gyroscopes and magnetic sensors to calculate position, orientation and velocity.}}
...
\newglossaryentry{sinsg}{name={SINS},
    description={Strapdown Inertial Navigation System (SINS) are lightweight, low cost, digital navigation systems.}}
...
\newglossaryentry{dcmg}{name={DCM},
    description={Direction Cosine Matrix (DCM) is a matrix that transforms one coordinate reference frame to another.}}
