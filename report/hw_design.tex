...
Following communicative devices will used and act as ``mudule areas'', i.e. these units will be the central units of the \gls{pcb} layout.
\begin{itemize}[noitemsep]
\item{\makebox[3cm][l]{STM32F411RET} - Microcontoller unit}
\item{\makebox[3cm][l]{FT232RL} - \gls{usb}to serial converter (USART)}
...
\begin{figure}[tb]
	...
	\caption{Simple modle of third (3) revision circuit board areas}
