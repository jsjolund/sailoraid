...
{\huge\bfseries Project SailorAid}\\[0.4cm] % Title of your document
...
\vfill\vfill
\includegraphics[width=0.2\textwidth]{ltu.jpg}\\[1cm] % Include a department/university logo - this will require the graphicx package
