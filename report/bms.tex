...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png}%Missing: Cellstruct.png
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: cccv.png
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: variations.png
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: protection.png
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: powerinput.png
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: battery.png
	\caption{Battery management flowchart}
	\label{fig:battery}
\end{figure}


Three ICs where chosen for the \gls{bms}. The BQ28Z610 is a gas gauge \gls{ic} for Li-ion batteries from \gls{ti}, including these features:
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: modules.png
	\caption{Current setup.} %Current what setup?
	\label{fig:modules}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: charging.png
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing: diagram.png
	\caption{Connection diagram.}
	\label{fig:diagram}
\end{figure} 

Figure \ref{fig:bmspwb} shows the unpopulated \gls{pwb} that when soldered and tested would fulfill all requirements. It is supposed to be the entire \gls{bms}. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/missing.png} %Missing bmspwb.png
