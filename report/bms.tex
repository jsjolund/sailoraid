...
One of the most common form factors is the cylindrical cell referred to as 18650. That is $18mm$ in diameter and $65mm$ in length \cite[p. 26-27]{book}. The \autoref{fig:cellstruct} displays the parts that build up such a cylindrical cell.
