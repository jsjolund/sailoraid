...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/protection.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/powerinput.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/battery.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/modules.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/charging.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/diagram.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Figures/bmspwb.png}
