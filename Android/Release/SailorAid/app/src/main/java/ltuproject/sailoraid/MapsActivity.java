...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle extraswp = getIntent().getBundleExtra("bundle");
        if (extraswp != null){
            mWaypointRoute = (ArrayList<LatLng>) extraswp.getSerializable("ARRAYLIST");
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (!mWaypointRoute.isEmpty()){
            for (LatLng point:mWaypointRoute){
    ...
    private void removeMarker(Marker marker){
        ...
        args.putSerializable("ARRAYLIST",(Serializable)mWaypointRoute);
